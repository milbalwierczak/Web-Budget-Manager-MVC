    ...
    <div class="container px-4 px-lg-5 h-100">
        <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
            ...
            <div class="col-lg-8 align-self-baseline">
                ...
                <a class="btn btn-primary btn-xl me-sm-4 mb-3 mb-sm-0" href="/register">Zarejestruj się</a>
                <a class="btn btn-outline-secondary btn-xl mb-3 mb-sm-0" href="/login" style="box-shadow:0px 0px 0px 2px white inset; color: white">Zaloguj się</a>
            </div>
        </div>
    </div>
</header>
